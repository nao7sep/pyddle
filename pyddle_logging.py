...
logs_directory_path = os.path.join(global.get_main_script_directory_path(), "logs")
...
log_file_path = os.path.join(logs_directory_path, f"log-{pyddle_datetime.utc_to_roundtrip_file_name_string(datetime.datetime.now(datetime.UTC))}-{global.get_main_script_file_name_without_extension()}.log")
